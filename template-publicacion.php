        ...
        <div class="row pt-2 mx-auto">
          <div class="col-4">
            <button id="btnPrint" class="btn-utils">
              <span class="icon icon--gob-44 material-icons">print</span>
              <span>Imprimir</span>
            </button>
          </div>
          <div class="col-4">
            <button type="button" id="btnShare" onclick="javascript:window.print()" class="btn-utils">
              <span class="icon icon--gob-44 material-icons">share</span>
              <span>Compartir</span>
            </button>
          </div>
          <div class="col-4">
            <button type="button" id="btnSave" class="btn-utils">
              <span class="icon icon--gob-44 material-icons">bookmark_border</span>
              <span>Guardar</span>
            </button>
          </div>
        </div>
