      ...
      <div class="accordion-item border-0">
        <div class="accordion-header row g-0" id={"collapsablehead" + id}>
          ...
          <div class="col-3 d-flex align-items-center justify-content-center justify-content-lg-end">
            <button class="button button--tertiary accordion-button button--dflex justify-content-center w-75 collapsed" type="button" data-bs-toggle="collapse" data-bs-target={"#collapsable" + id} aria-expanded="false" aria-controls={"collapsable" + id}>
